          ...
          () => Row(
            ...
            children: [
              TextButton(
                  ...
                  child: Row(children: [
                    Text(
                      "Total Data : ${controller.lstTask.length}",
                      style: TextStyle(
                          color: Colors.white,
                          fontFamily: "Roboto",
                          fontSize: 18,
            ...
            return Container(
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return InkWell(
                    onTap: () {
                      controller.getTaskDetail(controller.lstTask[index]['id']);
                    },
                    child: Padding(
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        controller.lstTask[index]['userId']
                                            .toString(),
                                        textAlign: TextAlign.left,
                                        style: TextStyle(
                                            color: Color.fromRGBO(
